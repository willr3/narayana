...
public class TransactionSynchronizationRegistryImple implements TransactionSynchronizationRegistry, Serializable, ObjectFactory
{
    ...
    {
        jtaLogger.logger.tracef("TransactionSynchronizationRegistryImple.getTransactionKey");
    ...
    {
        jtaLogger.logger.tracef("TransactionSynchronizationRegistryImple.putResource");
    ...
    {
        jtaLogger.logger.tracef("TransactionSynchronizationRegistryImple.getResource");
    ...
    {
        jtaLogger.logger.tracef("TransactionSynchronizationRegistryImple.registerInterposedSynchronization");
    ...
    {
        jtaLogger.logger.tracef("TransactionSynchronizationRegistryImple.getTransactionStatus");
    ...
    {
        jtaLogger.logger.tracef("TransactionSynchronizationRegistryImple.setRollbackOnly");
    ...
    {
        jtaLogger.logger.tracef("TransactionSynchronizationRegistryImple.getRollbackOnly");
